...
export function resetRepositoriesForTests(){activeRepositories=null;if(process.env.DATABASE_URL&&process.env.STORAGE_BACKEND==="postgres")initializeRepositories("postgres");}
